  ...
  if (state.isSelectMode) {
    ...
    `;
        ...
        zipDlBtnHtml = `
          ...
          <button class="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-5 py-2.5 rounded-full text-[15px] font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition shadow-sm flex items-center gap-2" onclick="navigator.clipboard.writeText(window.location.href); const t=this.querySelector('span'); const orig=t.innerText; t.innerText='Copied!'; setTimeout(()=>t.innerText=orig, 2000);">
