...
export function renderAlbumDetail(album) {
  ...
  if (state.isSelectMode) {
    ...
    `;
      ...
      const shareBtnHtml = `
        <button class="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 w-[42px] h-[42px] rounded-full flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition shadow-sm flex-shrink-0" onclick="shareAlbum('${album.title.replace(/'/g, "\\'").replace(/"/g, '&quot;')}')" title="このアルバムを共有">
